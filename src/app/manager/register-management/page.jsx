 ...
 * 
 */
const columnNames = ["Mã đơn","Họ", "Tên", "Ngày bắt đầu hợp đồng", "Mã đồng hồ - Địa chỉ cấp điện", "Loại điện"]
export default function PageManagedRegister (){
    ...
    const [subfrmSelectPowerMeterIsOpen, setSubfrmSelectPowerMeterIsOpen] = useState(false);
